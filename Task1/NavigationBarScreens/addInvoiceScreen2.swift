...
//                    .padding(.leading,20)
//
//                    FilterSearchBar(heading: "List Of Items", placeholder: " ", options: ["Electronics", "Mobiles", "Laptops", "Headphones",
//                                    "Watches", "Home Appliances", "Books", "Toys"])
//                    InvoiceTableView()
//
//                }
//            }
...
//                                    .frame(width: 100, alignment: .trailing)
//                                Text(String(format: "%.2f", Double(invoice.price)))
//                                    .frame(width: 100, alignment: .trailing)
//                                Text("\(invoice.units)")
//                                    .frame(width: 100, alignment: .trailing)
//
//                                // MARK: Action Dropdown
...
//    }
//
//    private func updateInvoice(_ updatedInvoice: Invoice) {
...
//                        Button(action: {
//                            let newItem = searchText.trimmingCharacters(in: .whitespacesAndNewlines)
//                            if !newItem.isEmpty && !allOptions.contains(newItem) {
//                                allOptions.append(newItem)
//                                selectedOptions.append(newItem)
//                                searchText = ""
...
//                                .padding(.vertical, 10)
//                                .padding(.horizontal, 15)
//                                .background(selectedOptions.contains(option) ? Color(hex: "E9F1FF") : Color.white)
//                                .foregroundColor(.black)
//                            }
//                            Divider()
//                        }
...
//}
//
//// MARK: - FlowLayout (chips wrap automatically)
...
//        // Approximate height for 2-3 lines of chips
...
////                    ForEach(selectedOptions, id: \.self) { item in
////                        HStack(spacing: 5) {
////                            Text(item)
////                                .font(.system(size: 14))
////                                .foregroundColor(.black)
