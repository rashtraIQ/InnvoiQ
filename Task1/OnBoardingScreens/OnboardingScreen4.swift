...
//    @ObservedObject var businessInfo: BusinessInfo
//    @FocusState private var isEmailFieldFocused: Bool
//    @State private var navigateNext: Bool = false   // ✅ to control navigation
//
//    var body: some View {
//        NavigationStack {
//            ZStack(alignment: .bottom) {
...
//
//                    Text("Where is your business Email?")
//                        .font(.system(size: 21.52, weight: .bold))
//                        .foregroundStyle(Color(hex: "#000000"))
//
//                    Text("This will help us pre-set your contact details")
//                        .font(.system(size: 14, weight: .semibold))
//                        .foregroundStyle(Color(hex: "#4B5563"))
//
//                    VStack(spacing: 45) {
//                        TextField("Enter business email", text: $businessInfo.email)
//                            .focused($isEmailFieldFocused)
//                            .padding(.horizontal, 12)
//                            .padding(.vertical, 10)
//                            .background(RoundedRectangle(cornerRadius: 7.36).fill(Color.white))
...
//                            .autocorrectionDisabled(true)
//
//                        // ✅ NavigationLink wraps Continue button
//                        NavigationLink(destination: OnboardingScreen3(businessInfo: businessInfo), isActive: $navigateNext) {
//                            Button {
//                                navigateNext = true   // trigger navigation
//                            } label: {
...
//
//#Preview {
//    OnboardingScreen2(businessInfo: BusinessInfo())
//}
//
